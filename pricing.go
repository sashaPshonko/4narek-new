...
const (
	...
	ahBookMinLotsInWindow   = 20 // уникальных uuid за 3 мин; меньше — скан тонкий, min/↑ не считаем
...
func actionReasonRU(action string) string {
	...
	case "corridor_price_up_ah_book":
		return "corridor_v8j: селл < min(3 мин ah_book)+наценка, ≥20 uuid → к min+наценка+шаг"
