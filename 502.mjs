...
const bots = [
  ...
  { username: 'oioioier666', password: 'ggggg', anarchy: 5002, type: '4narek', inventoryPort: 3000, balance: undefined, msgTime: null, isManualStop: false, itemPrices: items, item: 'netherite sword', ip: '192.168.0.57', itemID: "sword7"  },
