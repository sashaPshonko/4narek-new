...
2. Иначе книга: ≥10 лотов SKU за **3 мин** (не 10 — слишком длинно), любой ник. Потолок = **min цены + наценка**. Бот шлёт уже мин АХ+наценку. Если предложенное **выше** потолка → не пишем.
