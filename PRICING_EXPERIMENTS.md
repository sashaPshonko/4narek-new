...
Коридор книги (уже v8j, то же окно 3 мин): ↑ к min+наценка+шаг; ↓ клип к ≥2 забаненным витринам ≥min+наценка.

Policy циклов: `stock_corridor_v8k` (= v8j + этот замок). На VPS до pull/рестарта с панели — ещё старое.
