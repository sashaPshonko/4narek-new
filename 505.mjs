...
const bots = [
  { username: 'bugulmark2', password: 'ggggg', anarchy: 504, type: '4narek', inventoryPort: 3002, balance: undefined, msgID: 0, msgTime: null, isManualStop: false, itemPrices: items, item: 'netherite helmet' },
  { username: 'otstalyibolvan', password: 'ggggg', anarchy: 504, type: '4narek', inventoryPort: 3000, balance: undefined, msgID: 0, msgTime: null, isManualStop: false, itemPrices: items, item: 'netherite helmet' },
  { username: 'zbnennabite', password: 'ggggg', anarchy: 504, type: '4narek', inventoryPort: 3002, balance: undefined, msgID: 0, msgTime: null, isManualStop: false, itemPrices: items, item: 'netherite helmet' },
];
